...
# Usage:   ~/aws-security-reference-architecture-examples/aws_sra/utils/packaging_scripts/stage_solution.sh \
...
# Example: ~/aws-security-reference-architecture-examples/aws_sra/utils/packaging_scripts/stage_solution.sh \
#          --profile management-account-profile \
#          --staging_bucket_name sra-staging-123456789012-us-east-1 \
#          --solution_directory ~/aws-security-reference-architecture-examples/aws_sra/solutions/cloudtrail/cloudtrail_org
###########################################################################################
...
where:
    ...
    --solution_directory [optional] SRA Solution Directory Path, example = ~/aws-security-reference-architecture-examples/aws_sra/solutions/cloudtrail/cloudtrail_org"
